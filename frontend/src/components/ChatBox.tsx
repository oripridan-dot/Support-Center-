...
import { Send, Bot, Sparkles, FileText, ExternalLink } from 'lucide-react';
    ...
    <div className="flex flex-col h-full w-full bg-transparent overflow-hidden">
      ...
      >
        ...
        {messages.map((msg, idx) => (
          ...
          >
            <div className={cn(
              "flex-shrink-0 w-10 h-10 rounded-2xl flex items-center justify-center shadow-lg relative overflow-hidden",
              msg.role === 'user' ? "bg-white border border-gray-100" : "bg-white border border-gray-100"
            )}
            style={msg.role === 'user' ? {} : {}}
            >
              {msg.role === 'user' ? (
